...
function nextTurn(){
 ...
 // Crunch automático: ao chegar o turno de um estúdio bloqueado,
 // ele perde esse turno, é desbloqueado e o servidor avança sozinho.
 if(t?.blocked){
   t.blocked=0;
   t.pendingRoll=null;
   emitGame();
...
function rollCurrent(ack){
 ...
 io.emit('game:moved',{teamId:t.id,roll:n,from,to,pos:to});
